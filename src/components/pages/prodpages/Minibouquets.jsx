...
function Minibouquets() {
  ...
  const { minibouquets } = useSelector(x => x);
  ...
  const addToFav = (id) => {
    let item = minibouquets.find((a) => a.id === id);
  ...
  const addToCart = (id) => {
    let prod = minibouquets.find((a) => a.id === id);
    let newProd = [...tocart];
                  ...
                  <div className="one-item" id={a.name.replace(/\s/g, "")} key={i}>
                    ...
                    >
                      <SwiperSlide className='item-slider'>
                        <img src={a.image1} alt="minibouquet" />
                      </SwiperSlide>
                      <SwiperSlide className='item-slider'>
                        <img src={a.image2} alt="minibouquet" />
                      </SwiperSlide>
                    </Swiper>
