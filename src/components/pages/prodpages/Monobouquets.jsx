...
function Monobouquets() {
  ...
  const { monobouquets } = useSelector(x => x);
  ...
  const addToFav = (id) => {
    let item = monobouquets.find((a) => a.id === id);
  ...
  const addToCart = (id) => {
    let prod = monobouquets.find((a) => a.id === id);
    let newProd = [...tocart];
                  ...
                  <div className="one-item" id={a.name.replace(/\s/g, "")} key={i}>
                    ...
                    >
                      <SwiperSlide className='item-slider'>
                        <img src={a.image1} alt="monobouquet" />
                      </SwiperSlide>
                      <SwiperSlide className='item-slider'>
                        <img src={a.image2} alt="monobouquet" />
                      </SwiperSlide>
                    </Swiper>
