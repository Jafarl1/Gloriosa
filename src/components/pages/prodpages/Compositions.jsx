...
export default function Compositions() {
  ...
  const { compositions } = useSelector(x => x);
  ...
  const addToFav = (id) => {
    let item = compositions.find((a) => a.id === id);
  ...
  const addToCart = (id) => {
    let prod = compositions.find((a) => a.id === id);
    let newProd = [...tocart];
                  ...
                  <div className="one-item" id={a.name.replace(/\s/g, "")} key={i}>
                    ...
                    >
                      <SwiperSlide className='item-slider'>
                        <img src={a.image1} alt="composition" />
                      </SwiperSlide>
                      <SwiperSlide className='item-slider'>
                        <img src={a.image2} alt="composition" />
                      </SwiperSlide>
                    </Swiper>
