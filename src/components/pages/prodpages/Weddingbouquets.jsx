...
function Weddingbouquets() {
  ...
  const { weddingbouquets } = useSelector(x => x);
  ...
  const addToFav = (id) => {
    let item = weddingbouquets.find((a) => a.id === id);
  ...
  const addToCart = (id) => {
    let prod = weddingbouquets.find((a) => a.id === id);
    let newProd = [...tocart];
                  ...
                  <div className="one-item" id={a.name.replace(/\s/g, "")} key={i}>
                    ...
                    >
                      <SwiperSlide className='item-slider'>
                        <img src={a.image1} alt="weddingbouquet" />
                      </SwiperSlide>
                      <SwiperSlide className='item-slider'>
                        <img src={a.image2} alt="weddingbouquet" />
                      </SwiperSlide>
                    </Swiper>
