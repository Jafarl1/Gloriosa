...
function Seasonbouquets() {
  ...
  const { seasonbouquets } = useSelector(x => x);
  ...
  const addToFav = (id) => {
    let item = seasonbouquets.find((a) => a.id === id);
  ...
  const addToCart = (id) => {
    let prod = seasonbouquets.find((a) => a.id === id);
    let newProd = [...tocart];
                  ...
                  <div className="one-item" id={a.name.replace(/\s/g, "")} key={i}>
                    ...
                    >
                      <SwiperSlide className='item-slider'>
                        <img src={a.image1} alt="seasonbouquet" />
                      </SwiperSlide>
                      <SwiperSlide className='item-slider'>
                        <img src={a.image2} alt="seasonbouquet" />
                      </SwiperSlide>
                    </Swiper>
